...
import {loadStates, updateStateSelection} from "../../../store/actions/customDataDownload/hourlyEmissions/hourlyEmissions";
...
const mapStateToProps = (state) => {
  return {
    stateTerritory: state.hourlyEmissions.stateTerritory,
