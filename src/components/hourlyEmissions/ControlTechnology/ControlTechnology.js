...
import {
  loadEmissionsControlTechnologies,
...
const ControlTechnology = ({
  ...
  appliedFilters,
  loadEmissionsControlTechnologiesDispatcher,
...
const mapStateToProps = (state) => {
  return {
    storeControlTechnology: state.hourlyEmissions.controlTechnology,
...
const mapDispatchToProps = (dispatch) => {
  return {
    loadEmissionsControlTechnologiesDispatcher: () => dispatch(loadEmissionsControlTechnologies()),
    updateControlTechnologySelectionDispatcher: (controlTechnology) =>
