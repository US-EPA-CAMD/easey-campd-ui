...
const titleUrl = `${config.services.content.uri}/campd/help-support/faqs/index.md`;
const contentUrl = `${config.services.content.uri}/campd/help-support/faqs/topics.json`;
