  ...
  data: [
    {
      ...
      facilityId: 3,
      unitId: "1",
      ownerOperator: "Alabama Power Company (Operator)",
      stateCode: "AL",
      complianceApproach: "Averaging Plan",
      avgPlanId: 60,
      emissionsLimitDisplay: 0.46,
      actualEmissionsRate: 0.53,
      avgPlanActual: 0.429,
      inCompliance: "YES",
    },
    {
