...
describe('Emissions Filter logic functions', () => {
  ...
  it('engages filter logic for allowance transactions', async () => {
    initialState.filterCriteria.filterMapping = [
      {
        ...
        vintageYear: '2012',
        programCode: 'ARP',
        buyAccountNumber: '056671FACLTY',
        sellAccountNumber: '999900001039',
        buyAccountTypeCode: 'FACLTY',
        sellAccountTypeCode: 'GENERAL',
        buyFacilityId: 56671,
        sellFacilityId: null,
        buyState: 'WV',
        sellState: null,
      ...
      },
      {
        ...
        vintageYear: '2015',
        programCode: 'CSSO2G1',
        buyAccountNumber: '001167FACLTY',
        sellAccountNumber: '999900001023',
        buyAccountTypeCode: 'FACLTY',
        sellAccountTypeCode: 'GENERAL',
        buyFacilityId: 1167,
        sellFacilityId: null,
      ...
      },
      {
        ...
        sellState: null,
        transactionTypeCode: 'PRIVATE',
        ownerOperator: 'Peter J Zaborowsky',
      },
      {
        transactionDate: '2019-01-07',
        vintageYear: '2017',
        programCode: 'CSNOX',
        buyAccountNumber: '003982FACLTY',
        sellAccountNumber: '999900001219',
        buyAccountTypeCode: 'FACLTY',
        sellAccountTypeCode: 'GENERAL',
        buyFacilityId: 3982,
        sellFacilityId: null,
      ...
      },
      {
        ...
        sellState: null,
        transactionTypeCode: 'PRIVATE',
        ownerOperator: 'Richard A Rosvold',
      },
      {
        transactionDate: '2019-01-07',
        vintageYear: '2017',
        programCode: 'CSOSG2',
        buyAccountNumber: '003982FACLTY',
        sellAccountNumber: '999900001220',
        buyAccountTypeCode: 'FACLTY',
        sellAccountTypeCode: 'GENERAL',
        buyFacilityId: 3982,
        sellFacilityId: null,
      ...
      {
        transactionDate: '2019-01-08',
        vintageYear: '2017',
        programCode: 'CSOSG2',
        buyAccountNumber: '006166FACLTY',
        sellAccountNumber: '000988FACLTY',
        buyAccountTypeCode: 'FACLTY',
        sellAccountTypeCode: 'FACLTY',
        buyFacilityId: 6166,
        sellFacilityId: 988,
        buyState: 'IN',
        sellState: 'IN',
      ...
      },
      {
        ...
        vintageYear: '2017',
        programCode: 'CSOSG2',
        buyAccountNumber: '056108FACLTY',
        sellAccountNumber: '001443FACLTY',
        buyAccountTypeCode: 'FACLTY',
        sellAccountTypeCode: 'FACLTY',
        buyFacilityId: 56108,
        sellFacilityId: 1443,
      ...
      },
      {
        ...
        vintageYear: '2017',
        programCode: 'CSOSG2',
        buyAccountNumber: '999900000178',
        sellAccountNumber: '999900001427',
        buyAccountTypeCode: 'GENERAL',
        sellAccountTypeCode: 'GENERAL',
        buyFacilityId: null,
        sellFacilityId: null,
        buyState: null,
    ...
    initialState.filterCriteria.timePeriod.startDate = '2019-01-01';
    initialState.filterCriteria.timePeriod.startDate = '2019-10-01';
    initialState.filterCriteria.facility.forEach((e) => {
      if (e.id === '3') {
        e.selected = true;
      }
