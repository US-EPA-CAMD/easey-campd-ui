...
export const engageFilterLogic = (dataType, dataSubType, affectedFilter, filterCriteriaCloned, updateFilterCriteriaDispatcher, engageFilterLogicSuccessDispatcher, removedFilter=false) =>{
