...
export const LOAD_DAILY_EMISSIONS_SUCCESS = "LOAD_DAILY_EMISSIONS_SUCCESS";
export const LOAD_MONTHLY_EMISSIONS_SUCCESS = "LOAD_MONTHLY_EMISSIONS_SUCCESS";
export const LOAD_QUARTERLY_EMISSIONS_SUCCESS = "LOAD_QUARTERLY_EMISSIONS_SUCCESS";
export const LOAD_OZONE_EMISSIONS_SUCCESS = "LOAD_OZONE_EMISSIONS_SUCCESS";
export const LOAD_ANNUAL_EMISSIONS_SUCCESS = "LOAD_ANNUAL_EMISSIONS_SUCCESS";
